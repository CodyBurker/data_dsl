...
export const KEYWORDS = [
    'VAR',
    'LOAD_CSV', 'LOAD_JSON', 'LOAD_EXCEL', 'THEN', 'KEEP_COLUMNS', 'SELECT', 'DROP_COLUMNS', 'FILTER', 'WHERE', 'DROP',
    'NEW_COLUMN', 'AS', 'RENAME_COLUMN', 'RENAME_COLUMNS', 'TO', 'SORT', 'STORE_AS',
    'EXPORT_CSV', 'EXPORT_EXCEL', 'SHEET', 'FILE', 'RANGE', 'AND', 'OR',
    'WITH', 'COLUMN',
    'JOIN', 'ON', 'TYPE',
    'GROUP_BY', 'AGGREGATE',
